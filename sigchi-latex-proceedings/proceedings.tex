...
\begin{table}[h!]
 \begin{center}
   \begin{tabular}{| c | c |}
   \hline
   \includegraphics[width=0.5\textwidth]{figures/ROC-Economics.png}
   &
   \includegraphics[width=0.5\textwidth]{figures/ROC-Business-Law.png}
   \\
   \hline
   \includegraphics[width=0.5\textwidth]{figures/roc-marketing.png}
	&   
   \includegraphics[width=0.5\textwidth]{figures/roc-management.png}
   \\
   \hline
   \end{tabular}
 \end{center}
...
\begin{table}[h!]
 \begin{center}
   ...
   \hline
   \includegraphics[width=0.5\textwidth]{figures/EconomicsPCA.png}
   &
   \includegraphics[width=0.5\textwidth]{figures/BusinessLawPCA.png}
   \\
   \hline
   \includegraphics[width=0.5\textwidth]{figures/MarketingPCA.png}
	&   
   \includegraphics[width=0.5\textwidth]{figures/ManagementPCA.png}
   \\
   \hline
   \end{tabular}
 \end{center}
